...
//    }
     ...
     */
//    @Pointcut("@annotation(com.one.myAspect.version1.ApiLog)")
//    public void controllerPointcut() {
//    }
     ...
     */
    @Pointcut("!@annotation(cn.homyit.onlineLeaveSystem.log.IgnoreApiLog)" +
            " && (@within(cn.homyit.onlineLeaveSystem.log.ApiLog) ||" +
            " @annotation(cn.homyit.onlineLeaveSystem.log.ApiLog))")
    public void controllerPointcut() {
    }
