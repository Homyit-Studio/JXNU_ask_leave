...
// */
//public class MasterStudentListener extends AnalysisEventListener<StudentDTO> {
//
//
...
//
//    public MasterStudentListener(SysStudentUserMapper userMapper,
...
//        String majorAndClass = data.getMajorAndClass().trim().substring();
