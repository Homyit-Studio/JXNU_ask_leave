...
//    @Test
//    void getPassword(){
//        System.out.println(passwordEncoder.encode("13870927516"));
//        System.out.println(passwordEncoder.encode("18754300820"));
//        System.out.println(passwordEncoder.encode("18702513664"));
//        System.out.println(passwordEncoder.encode("18482269081"));
//        System.out.println(passwordEncoder.encode("17607005932"));
//
...
//    @Test
//    void test08(){
//        leaveNoteService.allCounts();
//    }
//
//    @Test
//    void test09(){
//        DownloadNoteDTO downloadNoteDTO = new DownloadNoteDTO();
////        downloadNoteDTO.setStudentNumber(202126201001L);
////        downloadNoteDTO.setStartTime(new Date());
////        downloadNoteDTO.setEndTime(new Date());
//        leaveNoteService.selectNoteToDownload(downloadNoteDTO);
//    }
//
//    @Test
//    void test10(){
//        DownloadNoteDTO downloadNoteDTO = new DownloadNoteDTO();
//        downloadNoteDTO.setStartTime(new Date());
////        String json = String.valueOf(downloadNoteDTO);
////        System.out.println(String.valueOf(downloadNoteDTO));
////        DownloadNoteDTO downloadNoteDTO1 = (DownloadNoteDTO)JSONObject.parse(json);
/////
//        String jsonString = JSON.toJSONString(downloadNoteDTO);
//        System.out.println(jsonString);
//        DownloadNoteDTO downloadNoteDTO1 =JSONObject.parseObject(jsonString,DownloadNoteDTO.class);
//        System.out.println(downloadNoteDTO1);
//
//    }
//
//
